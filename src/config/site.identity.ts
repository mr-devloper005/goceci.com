export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'goceci',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Goceci',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'goceci.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://goceci.com',
